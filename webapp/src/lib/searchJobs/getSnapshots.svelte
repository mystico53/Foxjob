...
<div class="container">
	...
	{#if error}
		<div class="mb-4 rounded border border-red-200 bg-red-50 p-4 text-red-500">
	...
	{#if snapshots.length > 0}
		<div class="table-container">
			<table class="w-full">
				<thead>
					<tr>
						<th class="bg-gray-50 p-4 text-left font-semibold">ID</th>
						<th class="bg-gray-50 p-4 text-left font-semibold">Status</th>
						<th class="bg-gray-50 p-4 text-left font-semibold">Created</th>
						<th class="bg-gray-50 p-4 text-left font-semibold">Size</th>
						<th class="bg-gray-50 p-4 text-left font-semibold">Cost</th>
						<th class="bg-gray-50 p-4 text-left font-semibold">Actions</th>
					</tr>
				</thead>
				<tbody>
							...
							<td class="p-4">
								<div class="flex flex-col gap-2">
									<button
										...
										class="rounded px-3 py-1 text-sm transition-colors {downloadingSnapshots.has(
											snapshot.id
										)
	...
	{:else if !loading}
		<div class="rounded border p-4 text-gray-500">
