<script>
  ...
  // Initialize store value if needed
  onMount(() => {
...
<div class:hidden={!isSearching} class="card variant-glass-surface p-4 my-4">
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="flex items-center gap-2">
          ...
          <div>
              ...
              <div class="text-sm opacity-75">{$totalJobs ?? 0} jobs</div>
          </div>
      </div>
