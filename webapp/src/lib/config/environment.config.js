...
export const cloudFunctions = {
    ...
    downloadAndProcessSnapshot: {
      ...
      urls: {
        development: import.meta.env.VITE_DOWNLOAD_AND_PROCESS_SNAPSHOT_URL || 'https://ac5653ceee3e.ngrok-free.app/jobille-45494/us-central1/downloadAndProcessSnapshot',
