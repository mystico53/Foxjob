...
export const cloudFunctions = {
    ...
    downloadAndProcessSnapshot: {
      ...
      urls: {
        development: import.meta.env.VITE_DOWNLOAD_AND_PROCESS_SNAPSHOT_URL || 'https://403b-99-8-162-33.ngrok-free.app/jobille-45494/us-central1/downloadAndProcessSnapshot',
