...
export const environmentUrls = {
	development:
		import.meta.env.VITE_BASE_URL || `http://127.0.0.1:5001/${projectIds.development}/us-central1`,
	staging:
		import.meta.env.VITE_BASE_URL || `https://us-central1-${projectIds.staging}.cloudfunctions.net`,
	production:
		import.meta.env.VITE_BASE_URL ||
		`https://us-central1-${projectIds.production}.cloudfunctions.net`
};
...
export const cloudFunctions = {
	...
	downloadAndProcessSnapshot: {
		...
		urls: {
			development:
				import.meta.env.VITE_DOWNLOAD_AND_PROCESS_SNAPSHOT_URL ||
				'https://ac5653ceee3e.ngrok-free.app/jobille-45494/us-central1/downloadAndProcessSnapshot',
