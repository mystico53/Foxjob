...
<button class="variant-ghost btn btn-sm" on:click={() => (showModal = true)}>
	<div class="gap-4">
...
<FeedbackModal bind:show={showModal} title="Improve Foxjob" on:close={() => (showModal = false)}>
	<form on:submit|preventDefault={handleSubmit} class="space-y-4">
		<div>
			<textarea
				bind:value={feedbackText}
				rows="6"
				class="mx-auto max-w-xl rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
