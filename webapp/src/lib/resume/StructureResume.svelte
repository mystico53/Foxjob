...
<div class="container mx-auto p-4">
	<div class="variant-surface card mb-4 p-4">
		<button
			class="variant-filled-primary btn relative w-full"
				...
				{#if summary.experience.length > 0}
					<div class="card variant-ghost-surface p-4">
						...
						{#each summary.experience as company}
							<div class="variant-ghost-surface mb-4 p-4">
		...
		{:else if !loading}
			<div class="card variant-ghost-surface mt-4 p-4">
